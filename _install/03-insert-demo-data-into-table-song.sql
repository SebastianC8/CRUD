...
-- SELECT pc.idPersonaComida, p.nombre, c.nombre_comida, pc.veces from persona_has_comida pc join persona p on (pc.idPersona=p.id) join comida c on (pc.idComida=c.id)
